...
void RayMarcherExample_Generated::AllocateAllDescriptorSets()
{
  // allocate pool
  //
...
VkDescriptorSetLayout RayMarcherExample_Generated::CreateRayMarchDSLayout()
{
...
VkDescriptorSetLayout RayMarcherExample_Generated::CreatecopyKernelFloatDSLayout()
{
...
void RayMarcherExample_Generated::InitAllGeneratedDescriptorSets_RayMarch()
{
  // now create actual bindings
  //
  // descriptor set #0: RayMarchCmd (["out_color","grid"])
  {
