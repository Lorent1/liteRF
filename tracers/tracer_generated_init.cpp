...
{ 
  auto pObj = std::make_shared<RayMarcherExample_Generated>(); 
  pObj->SetVulkanContext(a_ctx);
  pObj->InitVulkanObjects(a_ctx.device, a_ctx.physicalDevice, a_maxThreadsGenerated); 
  return pObj;
}

void RayMarcherExample_Generated::InitVulkanObjects(VkDevice a_device, VkPhysicalDevice a_physicalDevice, size_t a_maxThreadsCount) 
{
...
VkBufferUsageFlags RayMarcherExample_Generated::GetAdditionalFlagsForUBO() const
{
  return VK_BUFFER_USAGE_TRANSFER_SRC_BIT;
}

uint32_t RayMarcherExample_Generated::GetDefaultMaxTextures() const { return 256; }

void RayMarcherExample_Generated::MakeComputePipelineAndLayout(const char* a_shaderPath, const char* a_mainName, const VkSpecializationInfo *a_specInfo, const VkDescriptorSetLayout a_dsLayout, VkPipelineLayout* pPipelineLayout, VkPipeline* pPipeline)
{
...
void RayMarcherExample_Generated::MakeComputePipelineOnly(const char* a_shaderPath, const char* a_mainName, const VkSpecializationInfo *a_specInfo, const VkDescriptorSetLayout a_dsLayout, VkPipelineLayout pipelineLayout, VkPipeline* pPipeline)
{
  VkPipelineShaderStageCreateInfo shaderStageInfo = {};
  shaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
  shaderStageInfo.stage = VK_SHADER_STAGE_COMPUTE_BIT;
...
RayMarcherExample_Generated::~RayMarcherExample_Generated()
{
...
void RayMarcherExample_Generated::InitHelpers()
{
  vkGetPhysicalDeviceProperties(physicalDevice, &m_devProps);
}


void RayMarcherExample_Generated::InitKernel_RayMarch(const char* a_filePath)
{
...
void RayMarcherExample_Generated::InitKernels(const char* a_filePath)
{
  InitKernel_RayMarch(a_filePath);
}

void RayMarcherExample_Generated::InitBuffers(size_t a_maxThreadsCount, bool a_tempBuffersOverlay)
{
  ReserveEmptyVectors();
...
void RayMarcherExample_Generated::AssignBuffersToMemory(const std::vector<VkBuffer>& a_buffers, VkDeviceMemory a_mem)
{
  ...
  for(size_t i=1;i<memInfos.size();i++)
  {
    ...
    {
      std::cout << "[RayMarcherExample_Generated::AssignBuffersToMemory]: error, input buffers has different 'memReq.memoryTypeBits'" << std::endl;
      return;
    }
  }
...
RayMarcherExample_Generated::MemLoc RayMarcherExample_Generated::AllocAndBind(const std::vector<VkBuffer>& a_buffers)
{
  MemLoc currLoc;
  if(a_buffers.size() > 0)
  {
...
RayMarcherExample_Generated::MemLoc RayMarcherExample_Generated::AllocAndBind(const std::vector<VkImage>& a_images)
{
  MemLoc currLoc;
  if(a_images.size() > 0)
  {
    ...
    for(size_t i=0; i<reqs.size(); i++)
    {
      ...
      {
        std::cout << "RayMarcherExample_Generated::AllocAndBind(textures): memoryTypeBits warning, need to split mem allocation (override me)" << std::endl;
        break;
      }
    } 
...
void RayMarcherExample_Generated::FreeAllAllocations(std::vector<MemLoc>& a_memLoc)
{
...
void RayMarcherExample_Generated::AllocMemoryForMemberBuffersAndImages(const std::vector<VkBuffer>& a_buffers, const std::vector<VkImage>& a_images)
{
...
VkPhysicalDeviceFeatures2 RayMarcherExample_Generated::ListRequiredDeviceFeatures(std::vector<const char*>& deviceExtensions)
{
...
RayMarcherExample_Generated::MegaKernelIsEnabled RayMarcherExample_Generated::m_megaKernelFlags;
